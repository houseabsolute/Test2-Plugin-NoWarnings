...
https://metacpan.org/release/Test2-Plugin-NoWarnings

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Test2::Plugin::NoWarnings
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Test2::Plugin::NoWarnings
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/Test2-Plugin-NoWarnings).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Test2-Plugin-NoWarnings)
or [via email](bug-test2-plugin-nowarnings@rt.cpan.org.
